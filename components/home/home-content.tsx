...
export function HomeContent() {
  ...
  const accuracyRate = stats.totalProblems > 0 
  ...
  const enabledOperationsList = enabledOps ? Object.entries(enabledOps)
      ...
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="text-center space-y-4">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">
            {currentUser ? `Welcome back, ${currentUser.name}!` : 'Train Your Mental Math Skills'}
          </h2>
          ...
          <Card>
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xl sm:text-2xl font-bold">{stats.totalProblems}</div>
          ...
          <Card>
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xl sm:text-2xl font-bold">{accuracyRate}%</div>
        ...
        <Card className="p-4 sm:p-8">
          <CardHeader className="text-center pb-4 sm:pb-6 px-0">
            ...
            <CardDescription className="text-sm sm:text-base">
              Start a new session with {currentUser?.preferences?.sessionLength || 10} problems. 
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {enabledOperationsList.length > 0 ? (
                enabledOperationsList.map((op) => (
                  <Badge key={op} variant="secondary" className="text-xs sm:text-sm">
                    {op}
                  </Badge>
                ))
              ) : (
                <>
                  <Badge variant="secondary" className="text-xs sm:text-sm">Addition</Badge>
                  <Badge variant="secondary" className="text-xs sm:text-sm">Subtraction</Badge>
                  <Badge variant="secondary" className="text-xs sm:text-sm">Multiplication</Badge>
                  <Badge variant="secondary" className="text-xs sm:text-sm">Division</Badge>
                </>
              )}
            </div>
